...
axs[0][0].hist(east_p0,np.linspace(0.0,3.0,30),color='C0',alpha=0.8)
...
axs[0][0].set_xlabel('east [mm/yr^0.5]')


axs[1][0].hist(north_p0,np.linspace(0.0,3.0,30),color='C0',alpha=0.8)
...
axs[1][0].set_xlabel('north [mm/yr^0.5]')

axs[2][0].hist(vertical_p0,np.linspace(0.0,50.0,30),color='C0',alpha=0.8)
...
axs[2][0].set_xlabel('vertical [mm/yr^0.5]')


axs[0][1].hist(east_p1,np.linspace(0.0,2.0,30),color='C0',alpha=0.8)
...
axs[0][1].set_xlabel('east [1/yr]')

axs[1][1].hist(north_p1,np.linspace(0.0,2.0,30),color='C0',alpha=0.8)
...
axs[1][1].set_xlabel('north [1/yr]')

axs[2][1].hist(vertical_p1,np.linspace(0.0,8.0,30),color='C0',alpha=0.8)
...
axs[2][1].set_xlabel('vertical [1/yr]')
fig.tight_layout()
